    ...
    <div class="container-fluid-lg">
            ...
            <div class="row g-md-4 gy-sm-5">
                <div class="col-xxl-3 col-xl-4 col-sm-6">
                    <a href="index.html" class="foot-logo theme-logo">
                        <img src="{{ asset('/') }}front/assets/images/logo/4.png" class="img-fluid blur-up lazyload" alt="">
                    </a>
        ...
        <div class="sub-footer sub-footer-lite section-b-space section-t-space">
            ...
            <ul class="payment-box">
                <li>
                    <img src="{{ asset('/') }}front/assets/images/icon/paymant/visa.png" class="blur-up lazyload" alt="">
                </li>
                <li>
                    <img src="{{ asset('/') }}front/assets/images/icon/paymant/discover.png" alt="" class="blur-up lazyload">
                </li>
                <li>
                    <img src="{{ asset('/') }}front/assets/images/icon/paymant/american.png" alt="" class="blur-up lazyload">
                </li>
                <li>
                    <img src="{{ asset('/') }}front/assets/images/icon/paymant/master-card.png" alt="" class="blur-up lazyload">
                </li>
                <li>
                    <img src="{{ asset('/') }}front/assets/images/icon/paymant/giro-pay.png" alt="" class="blur-up lazyload">
                </li>
            </ul>
        </div>
    </div>
