                        ...
                        <div class="rightside-menu support-sidemenu">
                            <div class="support-box">
                                <div class="support-image">
                                    <img src="{{ asset('/') }}front/assets/images/icon/support.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </div>
                                        ...
                                        <div
                                            ...
                                            <div class="dropdown-column">
                                                <a class="dropdown-item" href="index.html">
                                                    <img src="{{ asset('/') }}front/assets/images/theme/1.jpg"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                    <span>Kartshop</span>
                                                </a>

                                                <a class="dropdown-item" href="index-2.html">
                                                    <img src="{{ asset('/') }}front/assets/images/theme/2.jpg"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                    <span>Sweetshop</span>
                                                </a>

                                                <a class="dropdown-item" href="index-3.html">
                                                    <img src="{{ asset('/') }}front/assets/images/theme/3.jpg"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                    <span>Organic</span>
                                                </a>

                                                <a class="dropdown-item" href="index-4.html">
                                                    <img src="{{ asset('/') }}front/assets/images/theme/4.jpg"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                    <span>Supershop</span>
                                                </a>

                                                <a class="dropdown-item" href="index-5.html">
                                                    <img src="{{ asset('/') }}front/assets/images/theme/5.jpg"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                    <span>Slicktech</span>
                                                </a>
                                            </div>
                    ...
                    <div class="rightside-menu">
                        ...
                        <a target="_blank" class="btn mobile-app d-xxl-flex d-none"
                            ...
                            <div class="mobile-image">
                                <img src="{{ asset('/') }}front/assets/images/icon/mobile.png" class="img-fluid blur-up lazyload"
                                    alt="">
                            </div>
