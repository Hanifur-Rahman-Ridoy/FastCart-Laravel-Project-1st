                ...
                <div class="slider-animate">
                    <div>
                        <div class="home-contain rounded-0 p-0">
                            <img src="{{ asset('/') }}front/assets/images/grocery/banner/1.jpg"
    ...
    <div class="container-fluid-lg">
        <div class="slider-4-banner no-arrow slick-height">
            <div>
                <div class=" banner-contain-3 hover-effect">
                    <a href="javascript:void(0)">
                        <img src="{{ asset('/') }}front/assets/images/grocery/banner/2.jpg" class="bg-img blur-up lazyload" alt="">
                    </a>
            ...
            <div>
                <div class="banner-contain-3 hover-effect">
                    <a href="javascript:void(0)">
                        <img src="{{ asset('/') }}front/assets/images/grocery/banner/3.jpg" class="img-fluid bg-img" alt="">
                    </a>
                    <div class="banner-detail p-center-left w-75 banner-p-sm mend-auto">
                        <div>
            ...
            <div>
                <div class="banner-contain-3 hover-effect">
                    <a href="javascript:void(0)">
                        <img src="{{ asset('/') }}front/assets/images/grocery/banner/4.jpg" class="blur-up lazyload bg-img" alt="">
                    </a>
                    <div class="banner-detail p-center-left w-75 banner-p-sm mend-auto">
                        <div>
            ...
            <div>
                <div class="banner-contain-3 hover-effect">
                    <a href="javascript:void(0)">
                        <img src="{{ asset('/') }}front/assets/images/grocery/banner/5.jpg" class="blur-up lazyload bg-img" alt="">
                    </a>
                    <div class="banner-detail p-center-left w-75 banner-p-sm mend-auto">
                        <div>
                ...
                <div class="category-slider-1 arrow-slider wow fadeInUp">
                        ...
                        <div class="category-box-list">
                            ...
                            <div class="category-box-view">
                                <a href="shop-left-sidebar.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/category/1.png"
                    ...
                    <div>
                        <div class="category-box-list">
                            ...
                            <div class="category-box-view">
                                <a href="shop-left-sidebar.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/category/2.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                                <button onclick="location.href = 'shop-left-sidebar.html';" class="btn shop-button">
                                    <span>Shop Now</span>
                    ...
                    <div>
                        <div class="category-box-list">
                            ...
                            <div class="category-box-view">
                                <a href="shop-left-sidebar.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/category/3.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                                <button onclick="location.href = 'shop-left-sidebar.html';" class="btn shop-button">
                                    <span>Shop Now</span>
                    ...
                    <div>
                        <div class="category-box-list">
                            ...
                            <div class="category-box-view">
                                <a href="shop-left-sidebar.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/category/4.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                                <button onclick="location.href = 'shop-left-sidebar.html';" class="btn shop-button">
                                    <span>Shop Now</span>
                    ...
                    <div>
                        <div class="category-box-list">
                            ...
                            <div class="category-box-view">
                                <a href="shop-left-sidebar.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/category/5.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                                <button onclick="location.href = 'shop-left-sidebar.html';" class="btn shop-button">
                                    <span>Shop Now</span>
                    ...
                    <div>
                        <div class="category-box-list">
                            ...
                            <div class="category-box-view">
                                <a href="shop-left-sidebar.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/category/6.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                                <button onclick="location.href = 'shop-left-sidebar.html';" class="btn shop-button">
                                    <span>Shop Now</span>
                    ...
                    <div>
                        <div class="category-box-list">
                            ...
                            <div class="category-box-view">
                                <a href="shop-left-sidebar.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/category/7.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                                <button onclick="location.href = 'shop-left-sidebar.html';" class="btn shop-button">
                                    <span>Shop Now</span>
                    ...
                    <div>
                        <div class="category-box-list">
                            ...
                            <div class="category-box-view">
                                <a href="shop-left-sidebar.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/category/8.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                                <button onclick="location.href = 'shop-left-sidebar.html';" class="btn shop-button">
                                    <span>Shop Now</span>
                ...
                <div class="slider-7_1 arrow-slider img-slider">
                        ...
                        <div class="product-box-4 wow fadeInUp">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/fruits-vegetables/1.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/fruits-vegetables/2.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/fruits-vegetables/3.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.15s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/fruits-vegetables/4.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/fruits-vegetables/5.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.25s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/fruits-vegetables/6.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/fruits-vegetables/7.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.35s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/fruits-vegetables/8.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div class="bank-header">
                        <div class="bank-left w-100">
                            <div class="bank-image">
                                <img src="{{ asset('/') }}front/assets/images/grocery/bank/name/1.png" class="img-fluid" alt="">
                            </div>
                            <div class="bank-name">
                                <h2>GET 10% OFF</h2>
            ...
            <div>
                <div class="bank-offer">
                    <div class="bank-header">
                        <div class="bank-left w-100">
                            <div class="bank-image">
                                <img src="{{ asset('/') }}front/assets/images/grocery/bank/name/2.png" class="img-fluid" alt="">
                            </div>
                            <div class="bank-name">
            ...
            <div>
                <div class="bank-offer">
                    <div class="bank-header">
                        <div class="bank-left w-100">
                            <div class="bank-image">
                                <img src="{{ asset('/') }}front/assets/images/grocery/bank/name/3.png" class="img-fluid" alt="">
                            </div>
                            <div class="bank-name">
                        ...
                        <div class="top-selling-slider product-arrow">
                            <div>
                                <div class="product-image">
                                    <a href="product-left-thumbnail.html">
                                        <img src="{{ asset('/') }}front/assets/images/grocery/deal/big.png"
                ...
                <div class="slider-5_2 img-slider">
                    <div>
                        <div class="product-box-4 wow fadeInUp">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/deal/1.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                        ...
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/deal/2.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/deal/3.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                        ...
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/deal/4.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/deal/5.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                        ...
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/deal/6.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/deal/7.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/deal/8.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                        ...
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/deal/9.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                ...
                <div class="slider-7_1 arrow-slider img-slider">
                    <div>
                        <div class="product-box-4 wow fadeInUp">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/breakfast/1.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/breakfast/2.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/breakfast/3.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.15s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/breakfast/4.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/breakfast/5.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.25s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/breakfast/6.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/breakfast/7.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.35s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/breakfast/8.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                ...
                <div class="slider-7_1 arrow-slider img-slider">
                    <div>
                        <div class="product-box-4 wow fadeInUp">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/chemist/1.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/chemist/2.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/chemist/3.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.15s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/chemist/4.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/chemist/5.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.25s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/chemist/6.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/chemist/7.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.35s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/chemist/8.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
    ...
    <div class="container-fluid-lg">
        <div class="row gy-lg-0 gy-3">
            <div class="col-lg-6">
                <div class="banner-contain-3 hover-effect">
                    <div>
                        <img src="{{ asset('/') }}front/assets/images/grocery/banner/6.jpg" class="bg-img blur-up lazyload" alt="">
                        <div
            ...
            <div class="col-lg-6">
                <div class="banner-contain-3 hover-effect">
                    <img src="{{ asset('/') }}front/assets/images/grocery/banner/7.jpg" class="bg-img blur-up lazyload" alt="">
                    <div
                        class="banner-detail banner-detail-2 text-dark p-center-left w-75 banner-p-sm position-relative mend-auto">
                        <div>
                ...
                <div class="slider-7_1 arrow-slider img-slider">
                    <div>
                        <div class="product-box-4 wow fadeInUp">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/drink/1.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/drink/2.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/drink/3.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.15s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/drink/4.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/drink/5.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.25s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/drink/6.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/drink/7.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.35s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/drink/8.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                ...
                <div class="slider-7_1 arrow-slider img-slider">
                    <div>
                        <div class="product-box-4 wow fadeInUp">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/grocery/1.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/grocery/2.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/grocery/3.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.15s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/grocery/4.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/grocery/5.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.25s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/grocery/6.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/grocery/7.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.35s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/grocery/8.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
        ...
        <div class="row gy-lg-0 gy-3">
            <div class="col-lg-8">
                <div class="banner-contain-3 h-100 pt-sm-5 hover-effect">
                    <img src="{{ asset('/') }}front/assets/images/grocery/banner/8.png" class="bg-img blur-up lazyload" alt="">
                    <div
            ...
            <div class="col-lg-4">
                <div class="banner-contain-3 pt-lg-4 h-100 hover-effect">
                    <a href="javascript:void(0)">
                        <img src="{{ asset('/') }}front/assets/images/grocery/banner/9.jpg"
                ...
                <div class="slider-7_1 arrow-slider img-slider">
                    <div>
                        <div class="product-box-4 wow fadeInUp">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/personal-care/1.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/personal-care/2.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/personal-care/3.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.15s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/personal-care/4.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/personal-care/5.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.25s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/personal-care/6.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/personal-care/7.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.35s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/personal-care/8.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                ...
                <div class="slider-7_1 arrow-slider img-slider">
                    <div>
                        <div class="product-box-4 wow fadeInUp">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/kichen/1.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/kichen/2.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/kichen/3.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.15s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/kichen/4.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/kichen/5.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.25s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/kichen/6.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/kichen/7.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
                    ...
                    <div>
                        <div class="product-box-4 wow fadeInUp" data-wow-delay="0.35s">
                            <div class="product-image product-image-2">
                                <a href="product-left-thumbnail.html">
                                    <img src="{{ asset('/') }}front/assets/images/grocery/product/kichen/8.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                </a>
        ...
        <div class="slider-3-blog arrow-slider slick-height">
                ...
                <div class=" blog-box ratio_45">
                    <div class="blog-box-image">
                        <a href="blog-detail.html">
                            <img src="{{ asset('/') }}front/assets/images/grocery/blog/1.jpg" class="blur-up lazyload bg-img" alt="">
                        </a>
                    </div>
            ...
            <div>
                <div class="blog-box ratio_45">
                    <div class="blog-box-image">
                        <a href="blog-detail.html">
                            <img src="{{ asset('/') }}front/assets/images/grocery/blog/2.jpg" class="blur-up lazyload bg-img" alt="">
                        </a>
                    </div>
            ...
            <div>
                <div class="blog-box ratio_45">
                    <div class="blog-box-image">
                        <a href="blog-detail.html">
                            <img src="{{ asset('/') }}front/assets/images/grocery/blog/3.jpg" class="blur-up lazyload bg-img" alt="">
                        </a>
                    </div>
