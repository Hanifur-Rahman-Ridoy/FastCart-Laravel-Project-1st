                ...
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list">
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li>
                                <a href="{{ route('add-sub-category') }}">Add New Sub Category</a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-list">
                    ...
                    <li class="sidebar-list">
                        ...
                        <ul class="sidebar-submenu">
                            <li>
                                <a href="{{ route('unit-list') }}">Unit List</a>
                            </li>

                            <li>
                                <a href="{{ route('add-unit') }}">Add New Unit</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-list">
                        ...
                        <ul class="sidebar-submenu">
                            <li>
                                <a href="{{ route('product-list') }}">Prodcts</a>
                            </li>
